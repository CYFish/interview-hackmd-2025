...
# AWS EventBridge deployment script for ArXiv Collector
FUNCTION_NAME=arxiv-collector
REGION=ap-northeast-1
RULE_NAME="daily-arxiv-collection"
SCHEDULE="cron(0 1 * * ? *)"  # Run daily at 01:00 UTC

echo "========================================"
echo "🚀 Deploying EventBridge Rule for Collector"
echo "========================================"
...
RULE_ARN=$(aws events put-rule \
    ...
    --description "Triggers daily arXiv data collection" \
    --region $REGION \
    --query 'RuleArn' \
    --output text)
...
INPUT_JSON="{\\\"bucket\\\": \\\"hackmd-project-2025\\\", \\\"batch_size\\\": 10000}"
...
echo "Schedule: $SCHEDULE (daily at 01:00 UTC)"
